...
export const it: LocaleContent = {
  ...
  colophon: {
    note: 'Questa pagina appartiene al rilascio v0.4.0 — Architettura editoriale. I rilasci successivi amplieranno la superficie di ricerca senza modificare l’architettura.',
